class IncomingJobResponseModel {
  String? status;
  List<IncomingJobModel>? response;

  IncomingJobResponseModel({this.status, this.response});

  IncomingJobResponseModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    if (json['response'] != null) {
      response = <IncomingJobModel>[];
      json['response'].forEach((v) {
        response!.add(IncomingJobModel.fromJson(v));
      });
    }
  }
